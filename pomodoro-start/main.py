...
def reset_timer():
    ...
    #timer label back to "Timer"
    timer_label.config(text= "Timer")
    #Reset all the checkmarks
...
#we have to create a canvas, to lay out our images or text on top of each other
